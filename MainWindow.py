...
class MainWindow(Frame):
    def __init__(self, *args, **kwds):
        ...
        self.choice_overlapping_segments = wx.CheckBox(self.splitterwindow_rightpanel, -1, "Match segments: ")
        self.overlapping_segments_numerator = wx.SpinCtrl(self.splitterwindow_rightpanel, -1, "5")
        self.fraction_label = wx.StaticText(self.splitterwindow_rightpanel, -1, " out of ")
        self.overlapping_segments_denominator = wx.SpinCtrl(self.splitterwindow_rightpanel, -1, "6")
        self.choice_overlapping_segments_comparison = wx.Choice(self.splitterwindow_rightpanel, -1, choices=["Exactly", "Minimum", "Maximum"])
        ...
        self.Bind(wx.EVT_CHOICE, self.OnChoiceOverlappingSegmentsComparison, self.choice_overlapping_segments_comparison)
    ...
    def __do_layout(self):
        ...
        segmentmatch_sizer.Add(self.fraction_label, 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        segmentmatch_sizer.Add(self.overlapping_segments_denominator,1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        segmentmatch_sizer.Add(self.choice_overlapping_segments_comparison, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def OnChoiceOverlappingSegmentsComparison(self, event): # wxGlade: MainWindow.<event_handler>
