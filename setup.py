...
lexica=['orthographic_basque.txt', 'orthographic_dutch.txt', 
        ...
        'orthographic_turkish.txt','orthographic_vietnamese.txt', 
        'phonetic_english_celex.txt',
        'phonetic_english_cmu.txt', 'phonetic_french.txt',
        'phonetic_italian.txt']
        
lexica_paths=['data/'+lexicon for lexicon in lexica]

plugins=['__init__.py', 'base_plugin.py', 'orthographic_basque.py', 'orthographic_dutch.py', 'orthographic_english.py', 'orthographic_french.py', 'orthographic_german.py', 'orthographic_italian.py', 'orthographic_polish.py', 'orthographic_serbian.py', 'orthographic_serbian_cyrillic.py', 'orthographic_serbian_latin.py', 'orthographic_spanish.py',
'orthographic_turkish.py', 'orthographic_vietnamese.py', 'phonetic_english_celex.py', 'phonetic_english_cmu.py', 'phonetic_french.py', 'phonetic_italian.py', 'segment.py', 'subsyllabic_common.py']
